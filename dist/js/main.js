...
`,Ye="(min-width: 1099px)",Xe="(prefers-reduced-motion: reduce)",Ke=8e3,Ze=30,Qe=3.4,Je=1.3,we=.55,xe=1100,Ee=1,et=3,tt=1.7;function nt(){return/(^|\s)path-(zh-CN-)?index-html(\s|$)/.test(document.body.className||"")}function X(s){return Math.max(0,Math.min(1,s))}function ae(s){return s*s*(3-2*s)}const it=`#version 300 es
in vec2 p;
...
void main() {
  ...
  _stColor = c;
    ...
    `,i.querySelector(".canvas-modal__viewport").appendChild(n),document.body.appendChild(i),document.body.classList.add("canvas-modal-open");const a=new Rt(n),r=c=>{c.key==="Escape"&&l()},l=()=>{a.destroy(),i.remove(),document.body.classList.remove("canvas-modal-open"),document.removeEventListener("keydown",r)};i.querySelector(".canvas-modal__close").addEventListener("click",l),i.querySelector(".canvas-modal__overlay").addEventListener("click",l),document.addEventListener("keydown",r),i.querySelectorAll(".canvas-modal__btn").forEach(c=>{c.addEventListener("click",()=>{const o=c.dataset.action;o==="zoom-in"?a.zoomBy(Ce):o==="zoom-out"?a.zoomBy(1/Ce):o==="reset"&&a.reset()})})}}function Pt(s){const e=s.querySelector("#canvas-arrow");if(!e)return;Ae+=1;const t=`${Tt}${Ae}`;e.id=t,s.querySelectorAll("[marker-end]").forEach(n=>{n.setAttribute("marker-end",`url(#${t})`)})}class Rt{constructor(e){this.svg=e;const t=e.viewBox.baseVal;this.original={x:t.x,y:t.y,w:t.width,h:t.height},this.state={...this.original},this.pointers=new Map,this.pinch=null,this.svg.style.cursor="grab",this.svg.style.touchAction="none",this.onWheel=this.onWheel.bind(this),this.onPointerDown=this.onPointerDown.bind(this),this.onPointerMove=this.onPointerMove.bind(this),this.onPointerUp=this.onPointerUp.bind(this),this.svg.addEventListener("wheel",this.onWheel,{passive:!1}),this.svg.addEventListener("pointerdown",this.onPointerDown),this.svg.addEventListener("pointermove",this.onPointerMove),this.svg.addEventListener("pointerup",this.onPointerUp),this.svg.addEventListener("pointercancel",this.onPointerUp)}setViewBox(){const{x:e,y:t,w:n,h:i}=this.state;this.svg.setAttribute("viewBox",`${e} ${t} ${n} ${i}`)}currentScale(){return this.original.w/this.state.w}zoomBy(e,t,n){const i=this.currentScale()*e;i<At||i>Mt||(t==null&&(t=this.state.x+this.state.w/2),n==null&&(n=this.state.y+this.state.h/2),this.state.x=t-(t-this.state.x)/e,this.state.y=n-(n-this.state.y)/e,this.state.w/=e,this.state.h/=e,this.setViewBox())}pan(e,t){this.state.x-=e,this.state.y-=t,this.setViewBox()}reset(){this.state={...this.original},this.setViewBox()}screenToSvg(e,t){const n=this.svg.createSVGPoint();n.x=e,n.y=t;const i=this.svg.getScreenCTM();return i?n.matrixTransform(i.inverse()):{x:0,y:0}}onWheel(e){e.preventDefault();const t=e.deltaY<0?ke:1/ke,{x:n,y:i}=this.screenToSvg(e.clientX,e.clientY);this.zoomBy(t,n,i)}onPointerDown(e){e.target.closest("a")||(this.svg.setPointerCapture(e.pointerId),this.pointers.set(e.pointerId,{clientX:e.clientX,clientY:e.clientY,svg:this.screenToSvg(e.clientX,e.clientY)}),this.pointers.size===2?this.pinch=this.computePinch():this.pointers.size===1&&(this.svg.style.cursor="grabbing"))}onPointerMove(e){const t=this.pointers.get(e.pointerId);if(t){if(t.clientX=e.clientX,t.clientY=e.clientY,this.pointers.size===2&&this.pinch){const n=this.computePinch(),i=n.dist/this.pinch.dist;if(i>0&&Number.isFinite(i)){const a=this.screenToSvg(n.cx,n.cy);this.zoomBy(i,a.x,a.y)}this.pinch=n}else if(this.pointers.size===1){const n=this.screenToSvg(e.clientX,e.clientY);this.pan(n.x-t.svg.x,n.y-t.svg.y)}}}onPointerUp(e){this.pointers.delete(e.pointerId),this.pointers.size<2&&(this.pinch=null),this.pointers.size===0&&(this.svg.style.cursor="grab")}computePinch(){const[e,t]=[...this.pointers.values()],n=t.clientX-e.clientX,i=t.clientY-e.clientY;return{dist:Math.hypot(n,i),cx:(e.clientX+t.clientX)/2,cy:(e.clientY+t.clientY)/2}}destroy(){this.svg.removeEventListener("wheel",this.onWheel),this.svg.removeEventListener("pointerdown",this.onPointerDown),this.svg.removeEventListener("pointermove",this.onPointerMove),this.svg.removeEventListener("pointerup",this.onPointerUp),this.svg.removeEventListener("pointercancel",this.onPointerUp)}}const ue={en:{Home:"Home",Daily:"Daily",Archives:"Archives",About:"About",Portfolio:"Portfolio",Bilibili:"Bilibili",GitHub:"GitHub",Instagram:"Instagram",Douban:"Douban",Email:"Email",RSS:"RSS",Language:"Language",Copyright:"Copyright","Powered by":"Powered by","Modified based on":"Modified based on",theme:"theme","Mainly maintained using AI":"Mainly maintained using AI","Older Posts":"Older Posts","Newer Posts":"Newer Posts",Comments:"Comments","Switch to Chinese":"Switch to Chinese","Switch to English":"Switch to English","View Chinese Version":"查看中文版","View English Version":"View English Version",languageSwitched:"Switched to English",articleLanguageSwitched:"Switched to English version","tag-graph-hint":"Click tag to explore · Scroll to zoom · Drag to rearrange"},"zh-CN":{Home:"首页",Daily:"资讯",Archives:"归档",About:"关于",Portfolio:"作品集",Bilibili:"哔哩哔哩",GitHub:"GitHub",Instagram:"Instagram",Douban:"豆瓣",Email:"邮箱",RSS:"RSS",Language:"语言",Copyright:"版权所有","Powered by":"技术支持","Modified based on":"基于",theme:"主题","Mainly maintained using AI":"主要使用AI来维护","Older Posts":"上一页","Newer Posts":"下一页",Comments:"留言","Switch to Chinese":"切换至中文","Switch to English":"切换至英文","View Chinese Version":"查看中文版","View English Version":"View English Version",languageSwitched:"已切换至中文",articleLanguageSwitched:"已切换至中文版本","tag-graph-hint":"点击标签探索 · 滚轮缩放 · 拖拽移动"}},Nt=()=>(navigator.language||navigator.userLanguage).startsWith("zh")?"zh-CN":"en",Ne=()=>localStorage.getItem("siteLanguage")||Nt(),zt=()=>{const s=document.cookie.match(/(?:^|;\s*)lang_pref=([^;]+)/);return s?s[1]:null},_t=s=>{document.cookie="lang_pref="+s+"; path=/; max-age=31536000; samesite=lax"},ze=()=>{const s=document.querySelector('meta[name="article:lang"]');return s?s.content:window.location.pathname.includes(".zh-CN")?"zh-CN":"en"},_e=s=>{const e=document.querySelector(`link[rel="alternate"][hreflang="${s}"]`);if(!e)return null;const t=new URL(e.href,window.location.origin);return window.location.origin+t.pathname+t.search+t.hash},De=s=>{document.querySelectorAll(".lang-switch__opt").forEach(e=>{e.setAttribute("aria-pressed",e.getAttribute("data-lang")===s?"true":"false")})},fe=s=>{const e=ue[s];if(!e){console.warn("Language data not available for:",s);return}document.documentElement.lang=s,document.querySelectorAll("nav ul li a").forEach(c=>{const o=c.getAttribute("data-i18n-key");o&&e[o]&&(c.textContent=e[o])}),document.querySelectorAll("[data-i18n]").forEach(c=>{const o=c.getAttribute("data-i18n");e[o]&&(c.textContent=e[o])}),document.querySelectorAll("[data-title]").forEach(c=>{const o=c.getAttribute("data-title");e[o]&&c.setAttribute("data-title",e[o])});const a=document.querySelector(".pagination .extend.prev"),r=document.querySelector(".pagination .extend.next");a&&(a.textContent=e["Older Posts"]||a.textContent),r&&(r.textContent=e["Newer Posts"]||r.textContent),localStorage.setItem("siteLanguage",s),document.querySelectorAll("[data-i18n-tag]").forEach(c=>{const o=c.getAttribute("data-i18n-tag");if(s==="zh-CN"){const u=window.tagTranslations&&window.tagTranslations[o];u&&(c.textContent=u)}else c.textContent=o}),De(s)},Dt=s=>{const e=document.querySelector(".lang-notification");e&&e.remove();const t=document.createElement("div");t.className="lang-notification",t.textContent=s,document.body.appendChild(t),setTimeout(()=>{t.classList.add("show")},10),setTimeout(()=>{t.classList.remove("show"),setTimeout(()=>{t.parentNode&&t.parentNode.removeChild(t)},300)},2e3)},qe=s=>{if(_t(s),s===ze()){localStorage.setItem("siteLanguage",s),fe(s);return}const e=_e(s);if(e){localStorage.setItem("siteLanguage",s),window.location.href=e;return}fe(s);const t=ue[s]?ue[s].languageSwitched:"Language switched";Dt(t)},qt=()=>{const s=Ne()==="zh-CN"?"en":"zh-CN";qe(s)},Ft=()=>{document.querySelectorAll(".lang-switch__opt").forEach(s=>{s.addEventListener("click",e=>{e.preventDefault(),qe(s.getAttribute("data-lang"))})}),De(Ne())},Me=()=>{const s=ze(),e=zt();if(fe(e||s),e&&e!==s){const t=_e(e),n=t&&new URL(t,window.location.origin).pathname;n&&n!==window.location.pathname&&window.location.replace(t)}};function Ot(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Me):Me(),window.addEventListener("load",()=>{const s=document.getElementById("langSwitch");s&&s.addEventListener("click",e=>{e.preventDefault(),qt()}),Ft()})}function Ht(){const s=document.getElementById("tag-graph"),e=document.getElementById("tag-graph-container"),t=window.__TAG_GRAPH_DATA__;if(!s||!t||!t.nodes||t.nodes.length===0)return;const n=document.createElement("div");n.className="graph-loading",n.textContent="Loading",s.parentNode.appendChild(n);const i=t.archiveFilterTags||[],a={};i.forEach(function(d){a[d]=!0});function r(d){return String(d||"").replace(/-/g," ").replace(/\s+/g," ").trim().toLowerCase()}const l={};t.links.forEach(function(d){l[d.source]=(l[d.source]||0)+1,l[d.target]=(l[d.target]||0)+1});let c=1;t.nodes.forEach(function(d){const h=d.value||0;h>c&&(c=h)}),t.nodes.forEach(function(d){const h=d.value||0;d.symbolSize=Math.max(12,Math.min(70,12+h*(58/c)))});const o={};t.nodes.forEach(function(d){o[d.name]=[]});function u(d,h){!o[d]||!o[h]||d===h||(o[d].indexOf(h)===-1&&o[d].push(h),o[h].indexOf(d)===-1&&o[h].push(d))}t.links.forEach(function(d){u(d.source,d.target)});const y={};t.nodes.forEach(function(d){const h=r(d.name);y[h]||(y[h]=[]),y[h].push(d.name)}),Object.keys(y).forEach(function(d){const h=y[d];if(!(h.length<2))for(let g=0;g<h.length;g++)for(let C=g+1;C<h.length;C++)u(h[g],h[C])});const f={},b=[];i.forEach(function(d){o[d]!==void 0&&(f[d]=0,b.push(d))});let S=0;for(;S<b.length;){const d=b[S++];(o[d]||[]).forEach(function(h){f[h]===void 0&&(f[h]=f[d]+1,b.push(h))})}Object.keys(f).forEach(function(d){});const p=[{h:260,s:62,l:50},{h:15,s:80,l:55},{h:160,s:60,l:42},{h:220,s:72,l:52},{h:340,s:70,l:52},{h:45,s:85,l:50},{h:190,s:70,l:45},{h:90,s:55,l:45},{h:290,s:60,l:50},{h:30,s:75,l:48},{h:130,s:50,l:42},{h:0,s:70,l:55}];function x(d,h,g){return"hsl("+Math.round(d)+", "+Math.round(h)+"%, "+Math.round(g)+"%)"}const I={},q={},E=t.nodes.filter(function(d){return a[d.name]});E.sort(function(d,h){return h.value-d.value}),E.forEach(function(d,h){const g=p[h%p.length];q[d.name]=g,I[d.name]=x(g.h,g.s,g.l)});const P={};i.forEach(function(d){if(o[d]===void 0)return;const h={};h[d]=0;const g=[d];let C=0;for(;C<g.length;){const _=g[C++];(o[_]||[]).forEach(function(T){h[T]===void 0&&(h[T]=h[_]+1,g.push(T))})}P[d]=h});const J=t.nodes.filter(function(d){return!a[d.name]});let re=1;J.forEach(function(d){let h=1/0;i.forEach(function(g){if(!P[g])return;const C=P[g][d.name];C!==void 0&&C<h&&(h=C)}),h<1/0&&h>re&&(re=h)}),J.forEach(function(d){const h=[];let g=0;if(i.forEach(function(m){if(!P[m]||!q[m])return;let w=P[m][d.name];if(w===void 0)return;w===0&&(w=.5);const A=1/(w*w);h.push({ft:m,w:A}),g+=A}),g===0){I[d.name]="hsl(0, 0%, 82%)";return}let C=0,_=0,T=0,L=0;h.forEach(function(m){const w=m.w/g,A=q[m.ft],F=A.h*Math.PI/180;C+=Math.sin(F)*w,_+=Math.cos(F)*w,T+=A.s*w,L+=A.l*w});let R=Math.atan2(C,_)*180/Math.PI;R<0&&(R+=360);let O=T,H=L,v=1/0;h.forEach(function(m){const w=P[m.ft][d.name];w<v&&(v=w)});let k=(v-1)/Math.max(re-1,1);k=Math.max(0,Math.min(1,k));const z=Math.pow(k,.85),N=32,M=1-z*.35;O=Math.max(N,O*M),H=H+z*(82-H)*.78,I[d.name]=x(R,O,H)});const le=t.tagTranslations||{},ee={};Object.keys(le).forEach(function(d){ee[d]=le[d];const h=d.replace(/-/g," ");h!==d&&(ee[h]=le[d])});function te(d){return(typeof localStorage<"u"&&localStorage.getItem("siteLanguage")||"en")==="zh-CN"&&ee[d]?ee[d]:d}const ve=e.getBoundingClientRect(),W=ve.width||500,U=ve.height||400,ge=Math.min(W,U)*.28;E.forEach(function(d,h){const g=2*Math.PI*h/Math.max(E.length,1)-Math.PI/2;d.x=W/2+ge*Math.cos(g),d.y=U/2+ge*Math.sin(g)});const ye=Math.min(W,U)*.45;J.forEach(function(d,h){const g=2*Math.PI*h/Math.max(J.length,1);d.x=W/2+ye*Math.cos(g),d.y=U/2+ye*Math.sin(g)});const Be=60,D=t.nodes;for(let d=0;d<15;d++)for(let h=0;h<D.length;h++)for(let g=h+1;g<D.length;g++){const C=D[g].x-D[h].x,_=D[g].y-D[h].y,T=Math.sqrt(C*C+_*_),L=Be+(D[h].symbolSize+D[g].symbolSize)/2;if(T<L){const R=(L-T)/2,O=T>.1?C/T:Math.random()-.5,H=T>.1?_/T:Math.random()-.5;D[h].x-=O*R,D[h].y-=H*R,D[g].x+=O*R,D[g].y+=H*R}}let K=1,Z=[W/2,U/2];if(E.length>0){let d=1/0,h=-1/0,g=1/0,C=-1/0;E.forEach(function(L){const R=(L.symbolSize||20)/2+50;L.x-R<d&&(d=L.x-R),L.x+R>h&&(h=L.x+R),L.y-R<g&&(g=L.y-R),L.y+R>C&&(C=L.y+R)});const _=h-d,T=C-g;if(_>0&&T>0){const L=W/_,R=U/T;K=Math.min(L,R,1.5)*.8,K<.3&&(K=.3),Z=[(d+h)/2,(g+C)/2]}}t.nodes.forEach(function(d){d.itemStyle={color:I[d.name],borderColor:"#fff",borderWidth:1.5,shadowBlur:5,shadowColor:"rgba(0, 0, 0, 0.06)"},d.label={show:!0,formatter:function(){return te(d.name)},fontSize:Math.max(10,Math.min(15,9+(l[d.name]||0)*.5)),color:"#555",fontFamily:'"noto-sans-sc", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif'}});const j=e.querySelector(".tag-graph-hint");let be=null,ce=!1;function We(){ce||(ce=!0,j.classList.add("visible"),clearTimeout(be),be=setTimeout(function(){j.classList.remove("visible"),ce=!1},3e3))}e.addEventListener("mouseenter",We);const G=document.createElement("script");G.src="https://cdn.jsdelivr.net/npm/echarts@5.5.1/dist/echarts.min.js",G.integrity="sha384-Mx5lkUEQPM1pOJCwFtUICyX45KNojXbkWdYhkKUKsbv391mavbfoAmONbzkgYPzR",G.crossOrigin="anonymous",G.onload=function(){je()},G.onerror=function(){n.textContent="Failed to load chart library",n.style.color="#c44"},document.head.appendChild(G);function Ue(d){return d<10?750:d<20?1200:d<40?1650:2100}function je(){n.parentNode&&n.parentNode.removeChild(n);const d=window.matchMedia&&window.matchMedia("(pointer: coarse)").matches||"ontouchstart"in window,h=echarts.init(s),g={backgroundColor:"transparent",tooltip:{show:!0,enterable:!0,confine:!0,backgroundColor:"rgba(255, 255, 255, 0.97)",borderColor:"#e8e8e8",borderWidth:1,padding:[10,14],textStyle:{color:"#4b4848",fontFamily:'"noto-sans-sc", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif',fontSize:13},extraCssText:"border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.08); max-height: 260px; overflow-y: auto;",formatter:function(v){function k(N){return String(N??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function z(N,M){const m=k(N),w=k(M),A='style="display:block;color:#666;font-size:11px;line-height:1.6;padding:1px 0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:240px;text-decoration:none;"';return w?'<a href="'+w+'" '+A+">• "+m+"</a>":"<div "+A+">• "+m+"</div>"}if(v.dataType==="node"){const N=te(v.name);let M='<div style="font-weight:600;font-size:14px;margin-bottom:5px;color:'+(I[v.name]||"#795da3")+'">'+k(N)+"</div>";M+='<div style="color:#777;font-size:12px;margin-bottom:6px;">📄 '+v.value+" article"+(v.value>1?"s":"")+"</div>";const m=t.postTitles&&t.postTitles[v.name];return m&&m.length>0&&(M+='<div style="max-height:160px;overflow-y:auto;border-top:1px solid #eee;padding-top:5px;">',m.forEach(function(w){typeof w=="string"?M+=z(w,""):M+=z(w.title,w.path)}),M+="</div>"),M}if(v.dataType==="edge"){const N=v.data.source,M=v.data.target;let m='<span style="font-weight:600">'+k(te(N))+'</span> <span style="color:#bbb">↔</span> <span style="font-weight:600">'+k(te(M))+"</span>";m+='<br/><span style="color:#999;font-size:12px">📄 '+v.data.value+" article"+(v.data.value>1?"s":"")+"</span>";const w=[N,M].sort().join("	"),A=t.linkPosts&&t.linkPosts[w];return A&&A.length>0&&(m+='<div style="max-height:160px;overflow-y:auto;border-top:1px solid #eee;padding-top:5px;margin-top:5px;">',A.forEach(function(F){m+=z(F.title,F.path)}),m+="</div>"),m}}},animationDuration:1500,animationEasingUpdate:"quinticInOut",series:[{type:"graph",layout:"force",data:t.nodes,links:t.links,roam:!1,draggable:!d,force:{repulsion:Ue(t.nodes.length),edgeLength:[150,450],gravity:.12,friction:.6,layoutAnimation:!0},emphasis:{focus:"adjacency",blurScope:"global",itemStyle:{shadowBlur:20,shadowColor:"rgba(121, 93, 163, 0.45)",borderWidth:2,borderColor:"#fff"},lineStyle:{width:3,opacity:.85},label:{show:!0,fontSize:14,fontWeight:"bold",color:"#333"}},label:{position:"right",distance:6},lineStyle:{color:"#d0d0d0",width:1.5,curveness:0,opacity:.35},scaleLimit:{min:.3,max:4},zoom:K,center:Z}]};h.setOption(g);let C=!1,_=!1;if(E.length>0){const v=function(){if(_)return;if(C){_=!0,h.off("finished",v);return}const k=h.getModel(),z=k&&k.getSeriesByIndex&&k.getSeriesByIndex(0),N=z&&z.getGraph&&z.getGraph();let M=1/0,m=-1/0,w=1/0,A=-1/0,F=0;if(E.forEach(function(ie){const de=N&&N.getNodeByName&&N.getNodeByName(ie.name),se=de&&de.getLayout&&de.getLayout();let $,Y;se&&se.length>=2?($=se[0],Y=se[1]):($=ie.x||0,Y=ie.y||0);const B=(ie.symbolSize||20)/2+50;$-B<M&&(M=$-B),$+B>m&&(m=$+B),Y-B<w&&(w=Y-B),Y+B>A&&(A=Y+B),F++}),F===0)return;const Q=m-M,ne=A-w;if(Q<=0||ne<=0)return;let V=Math.min(W/Q,U/ne,1.5)*.8;V<.3&&(V=.3),_=!0,T=V,L=[(M+m)/2,(w+A)/2],h.setOption({series:[{zoom:V,center:L.slice()}]}),h.off("finished",v)};h.on("finished",v)}h.on("click",function(v){v.dataType==="node"&&t.tagPaths&&t.tagPaths[v.name]&&(window.location.href=t.tagPaths[v.name])}),h.on("mouseover",function(v){(v.dataType==="node"||v.dataType==="edge")&&(s.style.cursor="pointer")}),h.on("mouseout",function(){s.style.cursor="default"});let T=K||1,L=Z?[Z[0],Z[1]]:[0,0];if(!d){const v=e||s;v.addEventListener("wheel",function(m){m.preventDefault()},{passive:!1}),v.addEventListener("touchmove",function(m){m.touches.length>=2&&m.preventDefault()},{passive:!1});const k=h.getZr();k.on("mousewheel",function(m){m.event.preventDefault(),m.event.stopPropagation(),C=!0;const w=m.wheelDelta>0?1.08:1/1.08;let A=T*w;A<.3&&(A=.3),A>4&&(A=4),T=A,h.setOption({series:[{zoom:T}]})});let z=!1,N=[0,0],M=[0,0];k.on("mousedown",function(m){m.target||(z=!0,C=!0,N=[m.event.clientX,m.event.clientY],M=[L[0],L[1]],s.style.cursor="grabbing")}),k.on("mousemove",function(m){if(z){const w=m.event.clientX-N[0],A=m.event.clientY-N[1],F=s.clientWidth,Q=s.clientHeight,ne=F/T,V=Q/T;L[0]=M[0]-w*(ne/F),L[1]=M[1]-A*(V/Q),h.setOption({series:[{center:[L[0],L[1]]}]})}}),k.on("mouseup",function(){z&&(z=!1,s.style.cursor="default")}),k.on("globalout",function(){z&&(z=!1,s.style.cursor="default")})}if(d){const v=document.createElement("button");v.type="button",v.className="tag-graph-fs-btn",v.setAttribute("aria-label","Fullscreen"),v.innerHTML='<svg class="tag-graph-fs-ic tag-graph-fs-ic--open" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="15 3 21 3 21 9"></polyline><polyline points="9 21 3 21 3 15"></polyline><line x1="21" y1="3" x2="14" y2="10"></line><line x1="3" y1="21" x2="10" y2="14"></line></svg><svg class="tag-graph-fs-ic tag-graph-fs-ic--close" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',e.appendChild(v);let k=!1;const z=function(){if(!j)return;const m=typeof localStorage<"u"&&localStorage.getItem("siteLanguage")||"en";j.textContent=m==="zh-CN"?"双指缩放 · 拖动平移 · 点按进入标签":"Pinch to zoom · Drag to pan · Tap a tag",j.classList.add("visible"),setTimeout(function(){j.classList.remove("visible")},2600)},N=function(){k=!0,e.classList.add("tag-graph-fullscreen"),v.classList.add("is-fullscreen"),v.setAttribute("aria-label","Exit fullscreen"),document.body.style.overflow="hidden",document.body.classList.add("tag-graph-fs-active"),requestAnimationFrame(function(){h.resize(),h.setOption({series:[{roam:!0}]}),z()})},M=function(){k=!1,e.classList.remove("tag-graph-fullscreen"),v.classList.remove("is-fullscreen"),v.setAttribute("aria-label","Fullscreen"),document.body.style.overflow="",document.body.classList.remove("tag-graph-fs-active"),requestAnimationFrame(function(){h.resize(),h.setOption({series:[{roam:!1,zoom:T,center:L.slice()}]})})};v.addEventListener("click",function(m){m.preventDefault(),m.stopPropagation(),k?M():N()}),document.addEventListener("keydown",function(m){m.key==="Escape"&&k&&M()})}let R;window.addEventListener("resize",function(){clearTimeout(R),R=setTimeout(function(){h.resize()},150)});function O(){h.setOption({series:[{data:t.nodes}]})}window.addEventListener("storage",function(v){v.key==="siteLanguage"&&O()});const H=localStorage.setItem;localStorage.setItem=function(v,k){H.call(localStorage,v,k),v==="siteLanguage"&&setTimeout(O,50)}}}function Bt(s){if(s.querySelector("audio"))return!1;const e=s.querySelector("summary");return!(!e||/跟读|本节语音/.test(e.textContent||"")||s.parentElement&&s.parentElement.closest("details.callout"))}function Wt(s,e={}){const t=e.includeCallouts?"h1, h2, h3, h4, h5, h6, details.callout--foldable":"h1, h2, h3, h4, h5, h6",n=Array.from(s.querySelectorAll(t)),i=[];let a=1;const r=[];return n.forEach(l=>{const c=/^H[1-6]$/.test(l.tagName);let o,u,y=!1;if(c)o=parseInt(l.tagName[1],10),a=o,u=l.textContent;else{if(!Bt(l))return;o=a+1,y=!0;const p=l.querySelector("summary");if(u=Pe(p.textContent||"",l.getAttribute("data-callout")||"",{short:!0}),!u)return}let f=1;for(;i.length&&i[i.length-1].level>=o;){const p=i.pop();p.level===o&&(f=p.n+1)}i.push({level:o,n:f});const b=r.length;l.id||(l.id=y?`toc-item-${b}`:`heading-${b}`);const S=i.map(p=>p.n).join(".");l.dataset.tocNumber=S,r.push({element:l,level:o,index:b,id:l.id,text:u,number:S,virtual:y})}),r}function Ut(s){const e=document.createElement("aside");e.className="toc-drawer",e.innerHTML='<div class="toc-header"><span class="toc-title"></span><div class="toc-header__actions"><button type="button" class="toc-foldall"></button><button type="button" class="toc-close-btn"><span class="toc-close-btn__x" aria-hidden="true"></span></button></div></div><div class="toc-content"><div class="toc-list"></div></div>',document.body.appendChild(e);const t=e.querySelector(".toc-list"),n=s.map(i=>{const a=document.createElement("div");if(a.className=i.virtual?"toc-item toc-item--virtual":"toc-item",a.setAttribute("data-level",String(i.level)),a.setAttribute("data-index",String(i.index)),!i.virtual){const l=document.createElement("div");l.className="toc-collapse-btn",a.appendChild(l)}const r=document.createElement("span");return r.className="toc-item-text",r.style.cursor="pointer",r.innerHTML=`<span class="toc-number">${i.number}.</span> `,r.appendChild(document.createTextNode(i.text)),r.setAttribute("title",i.text),i.element.classList.contains("collapsed")&&a.classList.add("collapsed"),a.appendChild(r),t.appendChild(a),a});return{container:e,items:n}}const Fe="toc-panel-state";function Oe(){try{const s=localStorage.getItem(Fe);if(!s)return null;const e=JSON.parse(s);return!e||typeof e!="object"?null:e}catch{return null}}function jt(s){try{const t={...Oe()||{},...s};localStorage.setItem(Fe,JSON.stringify(t))}catch{}}function Gt(){return(document.documentElement.getAttribute("lang")||"").toLowerCase().indexOf("zh")===0?"zh":"en"}const Vt={zh:{title:"目录",open:"目录",hide:"收起目录",show:"打开目录"},en:{title:"Contents",open:"TOC",hide:"Hide contents",show:"Show contents"}};function $t(s){const e=s.querySelector(".toc-content"),t=s.querySelector(".toc-item.toc-reading");!e||!t||(e.scrollTop=t.offsetTop-e.clientHeight/2+t.offsetHeight/2)}function Yt(s){const e=Vt[Gt()],t=s.querySelector(".toc-title");t&&(t.textContent=e.title),s.setAttribute("aria-label",e.title);const n=s.querySelector(".toc-close-btn");n&&(n.setAttribute("aria-label",e.hide),n.setAttribute("title",e.hide));const i=document.createElement("button");i.type="button",i.className="toc-tab",i.setAttribute("aria-label",e.show),i.innerHTML='<span class="toc-tab__icon" aria-hidden="true"></span><span class="toc-tab__text">'+e.open+"</span>",document.body.appendChild(i);const a=document.createElement("div");a.className="toc-scrim",document.body.appendChild(a);function r(o,u){s.classList.toggle("is-open",o),i.classList.toggle("is-hidden",o),a.classList.toggle("is-visible",o),document.body.classList.toggle("toc-drawer-open",o),o&&$t(s),u&&jt({hidden:!o})}i.addEventListener("click",()=>r(!0,!0)),a.addEventListener("click",()=>r(!1,!0)),n&&n.addEventListener("click",o=>{o.stopPropagation(),r(!1,!0)}),document.addEventListener("keydown",o=>{o.key==="Escape"&&s.classList.contains("is-open")&&r(!1,!1)});const l=Oe(),c=window.matchMedia("(min-width: 1100px)").matches;return r(c&&!!l&&l.hidden===!1,!1),{setOpen:r}}function me(s,e,t){for(let n=e+1;n<s.length&&!(parseInt(s[n].getAttribute("data-level")||"1",10)<=t);n+=1)s[n].classList.add("toc-hidden")}function He(s,e,t){for(let n=e+1;n<s.length;n+=1){const i=parseInt(s[n].getAttribute("data-level")||"1",10);if(i<=t)break;if(i===t+1)s[n].classList.remove("toc-hidden");else{let a=!0;for(let r=n-1;r>e;r-=1){const l=parseInt(s[r].getAttribute("data-level")||"1",10);if(l<i&&s[r].classList.contains("collapsed")){a=!1;break}if(l<=t)break}a&&s[n].classList.remove("toc-hidden")}}}function Xt(s){const e=parseInt(s.tagName.charAt(1),10);let t=s.nextElementSibling;for(;t&&!(t.tagName&&/^H[1-6]$/.test(t.tagName)&&parseInt(t.tagName.charAt(1),10)<=e);){if(t.classList&&t.classList.contains("tags")){t=t.nextElementSibling;continue}t.style.display="none",t=t.nextElementSibling}}function Kt(s){const e=parseInt(s.tagName.charAt(1),10);let t=s.nextElementSibling;for(;t&&!(t.tagName&&/^H[1-6]$/.test(t.tagName)&&parseInt(t.tagName.charAt(1),10)<=e);){if(t.classList&&t.classList.contains("tags")){t.style.display="",t=t.nextElementSibling;continue}t.style.display="",t=t.nextElementSibling}}function pe(s,e,t){const n=e[t],i=s[t]&&s[t].element;if(!n||!i)return;const a=parseInt(n.getAttribute("data-level")||"1",10);!n.classList.contains("collapsed")?(n.classList.add("collapsed"),me(e,t,a),i.classList.contains("collapsed")||(i.classList.add("collapsed"),Xt(i))):(n.classList.remove("collapsed"),He(e,t,a),i.classList.contains("collapsed")&&(i.classList.remove("collapsed"),Kt(i)))}function Zt(s,e,t){e.forEach((n,i)=>{if(n.classList.contains("toc-item--virtual")||!n.querySelector(".toc-collapse-btn"))return;const a=n.classList.contains("collapsed");t?!a&&!n.classList.contains("toc-hidden")&&pe(s,e,i):a&&pe(s,e,i)})}function Qt(s,e,t){const n=e[t],i=s[t]&&s[t].element;if(!n||!i)return;const a=parseInt(n.getAttribute("data-level")||"1",10),r=i.classList.contains("collapsed");r&&!n.classList.contains("collapsed")?(n.classList.add("collapsed"),me(e,t,a)):!r&&n.classList.contains("collapsed")&&(n.classList.remove("collapsed"),He(e,t,a))}function Jt(s,e){e.forEach((i,a)=>{if(i.classList.contains("collapsed")){const r=parseInt(i.getAttribute("data-level")||"1",10);me(e,a,r)}}),e.forEach((i,a)=>{const r=i.querySelector(".toc-collapse-btn");r&&r.addEventListener("click",l=>{l.stopPropagation(),pe(s,e,a)})});const t=new Map;s.forEach((i,a)=>t.set(i.element,a));const n=new MutationObserver(i=>{i.forEach(a=>{if(a.type!=="attributes"||a.attributeName!=="class")return;const r=t.get(a.target);r!==void 0&&Qt(s,e,r)})});return s.forEach(i=>{n.observe(i.element,{attributes:!0,attributeFilter:["class"]})}),{observer:n}}const Te={1:{passed:"rgba(128,128,128,0.1)",reading:"rgba(66,153,225,0.15)",coming:"rgba(200,200,200,0.05)",active:"rgba(66,153,225,0.25)"},2:{passed:"rgba(128,128,128,0.1)",reading:"rgba(49,130,206,0.15)",coming:"rgba(200,200,200,0.05)",active:"rgba(49,130,206,0.25)"},3:{passed:"rgba(128,128,128,0.1)",reading:"rgba(44,82,130,0.15)",coming:"rgba(200,200,200,0.05)",active:"rgba(44,82,130,0.25)"},4:{passed:"rgba(128,128,128,0.1)",reading:"rgba(42,67,101,0.15)",coming:"rgba(200,200,200,0.05)",active:"rgba(42,67,101,0.25)"},5:{passed:"rgba(128,128,128,0.1)",reading:"rgba(26,54,93,0.15)",coming:"rgba(200,200,200,0.05)",active:"rgba(26,54,93,0.25)"},6:{passed:"rgba(128,128,128,0.1)",reading:"rgba(21,62,117,0.15)",coming:"rgba(200,200,200,0.05)",active:"rgba(21,62,117,0.25)"}};function en(s,e){if(!s.length)return{destroy(){}};const t=new Array(s.length).fill("coming"),n=new Set;let i=-1;const a=new Map;s.forEach((f,b)=>a.set(f.element,b));function r(){e.forEach((f,b)=>{const S=parseInt(f.getAttribute("data-level")||"1",10),p=Te[S]||Te[1],x=t[b];f.classList.remove("toc-passed","toc-reading","toc-coming"),f.style.boxShadow="",f.style.transform="",f.style.fontWeight="",b===i?(f.classList.add("toc-reading"),f.style.backgroundColor=p.active,f.style.opacity="1",f.style.fontWeight="600",f.style.boxShadow="inset 0 0 0 2px rgba(66,153,225,0.3)",f.style.transform="scale(1.02)",f.style.transition="all 0.2s ease"):x==="reading"?(f.classList.add("toc-reading"),f.style.backgroundColor=p.reading,f.style.opacity="1",f.style.fontWeight="600"):x==="passed"?(f.classList.add("toc-passed"),f.style.backgroundColor=p.passed,f.style.opacity="0.7"):(f.classList.add("toc-coming"),f.style.backgroundColor=p.coming,f.style.opacity="0.5")})}function l(){const f=window.innerHeight/2;let b=-1;n.forEach(S=>{const p=s[S].element.getBoundingClientRect();p.top<=f&&p.bottom>=f&&(b=S)}),b!==i&&(i=b,r())}let c=null;function o(){c||(c=requestAnimationFrame(()=>{c=null,l()}))}const u=new IntersectionObserver(f=>{f.forEach(b=>{const S=a.get(b.target);S!==void 0&&(b.isIntersecting?(n.add(S),t[S]="reading"):(n.delete(S),t[S]=b.boundingClientRect.bottom<0?"passed":"coming"))}),l(),r()});s.forEach(f=>u.observe(f.element)),window.addEventListener("scroll",o,{passive:!0}),window.addEventListener("resize",o,{passive:!0}),r();function y(){u.disconnect(),window.removeEventListener("scroll",o),window.removeEventListener("resize",o),c&&cancelAnimationFrame(c)}return{destroy:y,refresh:()=>{l(),r()}}}const tn='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M7.41 18.59 8.83 20 12 16.83 15.17 20l1.41-1.41L12 14zM16.59 5.41 15.17 4 12 7.17 8.83 4 7.41 5.41 12 10z"/></svg>',nn='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 5.83 15.17 9l1.41-1.41L12 3 7.42 7.59 8.83 9zm0 12.34L8.83 15l-1.41 1.4L12 21l4.58-4.6L15.17 15z"/></svg>';function sn(s){return!s.classList.contains("toc-item--virtual")&&!!s.querySelector(".toc-collapse-btn")}function an(){const s=document.querySelector(".content");if(!s||s.classList.contains("archives"))return null;const e=document.body;if(e.classList.contains("path-about-index-html")||e.classList.contains("layout-about"))return null;const t=document.querySelector("section.main[data-toc]");return t&&t.getAttribute("data-toc")==="false"?null:s}function on(){const s=an();if(!s)return;const e=Wt(s,{includeCallouts:document.body.classList.contains("type-daily-feed")});if(!e.length)return;const{container:t,items:n}=Ut(e);Jt(e,n);const i=en(e,n);Yt(t);const a=t.querySelector(".toc-foldall"),r=n.filter(sn);if(a&&r.length){const c=(document.documentElement.getAttribute("lang")||"").toLowerCase().indexOf("zh")===0?{collapse:"全部折叠",expand:"全部展开"}:{collapse:"Collapse all",expand:"Expand all"},o=()=>{const u=r.some(y=>!y.classList.contains("collapsed"));a.innerHTML=u?tn:nn,a.setAttribute("aria-label",u?c.collapse:c.expand),a.setAttribute("title",u?c.collapse:c.expand)};a.addEventListener("click",()=>{const u=r.some(y=>!y.classList.contains("collapsed"));Zt(e,n,u),o()}),o()}else a&&a.remove();n.forEach((l,c)=>{const o=l.querySelector(".toc-item-text");o&&o.addEventListener("click",()=>{const u=e[c];!u||!u.element||(u.virtual&&u.element.tagName==="DETAILS"&&!u.element.open&&(u.element.open=!0),u.element.scrollIntoView({behavior:"smooth",block:u.virtual?"start":"center"}),setTimeout(()=>i.refresh(),300))})})}function Ie(){new Ge,new at,new xt,document.getElementById("map")&&new Et,new St,setTimeout(()=>{new Lt},500),new Ct,new kt,new It,Ot(),on(),new bt,wt(),document.getElementById("tag-graph")&&Ht()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ie):Ie();
