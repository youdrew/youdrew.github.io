document.addEventListener('DOMContentLoaded', function () {
  ...
  function initTOCCollapse() {
    ...
    const isAboutPage =
      body.classList.contains('path-about-index-html') || body.classList.contains('layout-about');
    ...
    setTimeout(() => {
      ...
      tocItems.forEach((item, index) => {
        ...
        const isInitiallyCollapsed =
          correspondingHeading && correspondingHeading.classList.contains('collapsed');
  ...
  function initTOCDragMove(tocContainer) {
    ...
    tocContainer.addEventListener('mousedown', function (e) {
      ...
      if (
        e.target.classList.contains('toc-collapse-btn') ||
